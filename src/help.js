...
*BOT FEITO PELO OSWALDO NETTO*

whatsapp do criador: +5567996532507
Instagram: @oswaldo_netto19
facebook: não utilizo
outras redes sociais: tbm nao utilizo 
...
Desc: *Ativa o modo de boas vinda para o grupo*
...
Uso: *${prefix} setprefix [texto | opcional] * \ n *exemplo: * * $ {prefix}setprefix ? *
Nota: *Este comando só pode ser usado pelo proprietário do bot \n\n
`
}
